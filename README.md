...
#### 换行1
直接回车不能换行，（本括号后有1个回车）
可以在上一行文本后面补两个空格，（本括号后有2个空格1个回车）  
这样下一行的文本就换行了。或者就是在两行文本直接加一个空行，（本括号后有2个回车）

也能实现换行效果，相当于另起新段落，行间距更大。
#### In English（结构与`换行1`相同）
new line,
new line,  
new line,
...
new line.
#### 换行2
直接回车不能换行，（本括号后有2个空格1个回车）  
可以在上一行文本后面补两个空格，（本括号后有2个空格1个回车）  
这样下一行的文本就换行了。或者就是在两行文本直接加一个空行，（本括号后有2个回车）

也能实现换行效果，相当于另起新段落，行间距更大。
#### In English（结构与`换行2`相同）
new line,  
new line,  
new line,
