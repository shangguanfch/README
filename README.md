...
|2|`[![](/images/zhihu.png "我的知乎，欢迎关注")][zhihu]`|[![](/img/zhihu.png "我的知乎，欢迎关注")][zhihu]|
...
#### 有序列表自动排序
也可以在第一行指定`1. `，而接下来的几行用星号`1. `就可以了，它会自动显示成2、3、4…。
...
#### 多级有序列表
和无序列表一样，有序列表也有多级结构，在`1. `前加3或4个空格：  
